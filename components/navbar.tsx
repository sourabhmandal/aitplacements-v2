  ...
  return (
    <section className="bg-white border-b">
      <nav className="flex justify-between items-center p-2">
        ...
        <div className="sm:flex justify-between sm:flex-row w-full text-center mx-auto">
          <p className="font-bold text-green-600 text-lg p-2">
            AitPlacements.in
          </p>
      ...
      <div className="flex items-baseline justify-center">
        <div className="flex">
          <Link passHref href="/notice">
            <span className="cursor-pointer border-b-4 px-4 hover:border-green-600">
              Notice Board
            </span>
          </Link>
